            ...
            <div class="col-lg-4">
                <div class="list-info">
                    <ul>
                        ...
                        <li class="activado"><a href="delete_act">Eliminar cuenta</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-8" id="info-basic">
                <div class="info-basic">
                    <div class="row delete">
                        <div class="col-lg-12">
                            <h3>Borrar cuenta</h3>
                            <p class="delete-text">Puede borrar su cuenta en cualquier momento. Sin embargo, esta acci&oacute;n es irreversible.</p>
                        </div>
                        <div class="col-lg-6">
                            <div class="info-input-button">
                                <button type="button" id="delete-button">Entiendo, Eliminar mi cuenta</button>
                            </div>
                        </div>
                    </div>
                </div>
